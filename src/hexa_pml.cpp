		...
		if(face){
			...
			if(mask[PML_FACE_X0]){
				...
				for(int n_l = 0; n_l < layers_x; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+1*n_layers;
			...
			if(mask[PML_FACE_X1]){
				...
				for(int n_l = 0; n_l < layers_x; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+2*n_layers;
			...
			if(mask[PML_FACE_Y0]){
				...
				for(int n_l = 0; n_l < layers_y; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+3*n_layers;
			...
			if(mask[PML_FACE_Y1]){
				...
				for(int n_l = 0; n_l < layers_y; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+4*n_layers;
			...
			if(mask[PML_FACE_Z0]){
				...
				for(int n_l = 0; n_l < layers_z; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+5*n_layers;
			...
			if(mask[PML_FACE_Z1]){
				...
				for(int n_l = 0; n_l < layers_z; ++n_l ){
					...
					pml_e->n_mat = elem->n_mat+6*n_layers;
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						for(int nz = 0; nz < layers_z; nz++){
							...
							pml_e->n_mat = elem->n_mat+7*n_layers;
						}
					}
				}
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						for(int nz = 0; nz < layers_z; nz++){
							...
							pml_e->n_mat = elem->n_mat+8*n_layers;
						}
					}
				}
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						for(int nz = 0; nz < layers_z; nz++){
							...
							pml_e->n_mat = elem->n_mat+9*n_layers;
						}
					}
				}
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						for(int nz = 0; nz < layers_z; nz++){
							...
							pml_e->n_mat = elem->n_mat+10*n_layers;
						}
					}
				}
			}
			...
			if(mask[PML_EDGE_X0_Y0]){
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+12*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_X0_Y1]){
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+13*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_X1_Y0]){
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+14*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_X1_Y1]){
				...
				for(int nx = 0; nx < layers_x; nx++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+15*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_Z1_X0]){
				...
				for(int nz = 0; nz < layers_z; nz++){
					for(int nx = 0; nx < layers_x; nx++){
						...
						pml_e->n_mat = elem->n_mat+16*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_Z1_X1]){
				...
				for(int nz = 0; nz < layers_z; nz++){
					for(int nx = 0; nx < layers_x; nx++){
						...
						pml_e->n_mat = elem->n_mat+17*n_layers;
					}
				}
			...
			if(mask[PML_EDGE_Z1_Y0]){
				...
				for(int nz = 0; nz < layers_z; nz++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+18*n_layers;
					}
				}
			}
			if(mask[PML_EDGE_Z1_Y1]){
				...
				for(int nz = 0; nz < layers_z; nz++){
					for(int ny = 0; ny < layers_y; ny++){
						...
						pml_e->n_mat = elem->n_mat+20*n_layers;
					}
				}
